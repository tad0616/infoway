...
//文字大小[theme_css.html]
$config_enable['font_size']=array('enable'=>0, 'min'=>'' , 'max'=>'' , 'require'=>0 , 'default'=>'11pt');
//離下邊界距離[自]
$config_enable['margin_bottom']=array('enable'=>0, 'min'=>'' , 'max'=>'' , 'require'=>0 , 'default'=>'0');
//文字顏色[theme_css.html]
$config_enable['font_color']=array('enable'=>0, 'min'=>'' , 'max'=>'' , 'require'=>0 , 'default'=>'#202020');
//連結顏色[theme_css.html]
$config_enable['link_color']=array('enable'=>0, 'min'=>'' , 'max'=>'' , 'require'=>0 , 'default'=>'#005ca8');
//移到連結顏色[theme_css.html]
$config_enable['hover_color']=array('enable'=>0, 'min'=>'' , 'max'=>'' , 'require'=>0 , 'default'=>'#a40019');
...
$config_enable['bg_attachment']=array('enable'=>0, 'min'=>'' , 'max'=>'' , 'require'=>0 , 'default'=>'fixed');
...
//佈景圖片寬度[slideshow_responsive.html]，值：若bootstrap模式，最大值為 12，若 html 或 mix 模式，則輸入預設佈景圖片寬度，如： 980
$config_enable['slide_width']=array('enable'=>1, 'min'=>'' , 'max'=>'' , 'require'=>0 , 'default'=>'900');
//佈景圖片高度[slideshow_responsive.html]，值：數值，單位一律為 px
$config_enable['slide_height']=array('enable'=>1, 'min'=>'' , 'max'=>'' , 'require'=>0 , 'default'=>'285');
...
$config_enable['bt_text_size']=array('enable'=>1, 'min'=>'' , 'max'=>'20px' , 'require'=>0 , 'default'=>'16px');
//區塊標題縮排[theme_css_blocks.html]，值：數值，單位一律為 px
$config_enable['bt_text_padding']=array('enable'=>0, 'min'=>'' , 'max'=>'' , 'require'=>0 , 'default'=>'0');
//區塊標題文字顏色[theme_css_blocks.html]
$config_enable['bt_text']=array('enable'=>1, 'min'=>'' , 'max'=>'' , 'require'=>0 , 'default'=>'#585858');
//區塊標題背景顏色[theme_css_blocks.html]
$config_enable['bt_bg_color']=array('enable'=>0, 'min'=>'' , 'max'=>'' , 'require'=>0 , 'default'=>'transparent');
...
$config_enable['bt_bg_img']=array('enable'=>0, 'min'=>'' , 'max'=>'' , 'require'=>0 , 'default'=>'');
//區塊標題背景重複[theme_css_blocks.html]，值： 1 （重複）, 0 （不重複）
$config_enable['bt_bg_repeat']=array('enable'=>0, 'min'=>'' , 'max'=>'' , 'require'=>0 , 'default'=>'1');
...
$config_enable['block_title_style']=array('enable'=>1, 'min'=>'' , 'max'=>'' , 'require'=>0 , 'default'=>'font-weight: bold;margin-top: 30px;margin-bottom: 25px;padding-bottom: 10px;');
